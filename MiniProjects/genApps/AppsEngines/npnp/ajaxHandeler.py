...
def ajax_Parent(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= ParentManager.getParent(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= ParentManager.searchParent(name=name,email=email,phone=phone,occupation=occupation,address=address,income=income,relationship=relationship,secondary_contact=secondary_contact,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Parent_Student(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= ParentManager.getParent_Student(id=id,mv=mv)
...
def ajax_Employee(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= EmployeeManager.getEmployee(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= EmployeeManager.searchEmployee(name=name,uid=uid,address=address,age=age,designation=designation,rank=rank,max_qualification=max_qualification,meretarial_status=meretarial_status,gender=gender,dob=dob,doj=doj,categories=categories,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Employee_Subject(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= EmployeeManager.getEmployee_Subject(id=id,mv=mv)
...
def ajax_Employee_MyClass(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= EmployeeManager.getEmployee_MyClass(id=id,mv=mv)
...
def ajax_Employee_Exam(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= EmployeeManager.getEmployee_Exam(id=id,mv=mv)
...
def ajax_Subject(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= SubjectManager.getSubject(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= SubjectManager.searchSubject(name=name,uid=uid,syllabus=syllabus,ref_book=ref_book,teacher=teacher,categorise=categorise,group=group,mark_division=mark_division,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Subject_Employee(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= SubjectManager.getSubject_Employee(id=id,mv=mv)
...
def ajax_Subject_MyClass(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= SubjectManager.getSubject_MyClass(id=id,mv=mv)
...
def ajax_Subject_Exam(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= SubjectManager.getSubject_Exam(id=id,mv=mv)
...
def ajax_Subject_Mark(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= SubjectManager.getSubject_Mark(id=id,mv=mv)
...
def ajax_MyClass(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= MyClassManager.getMyClass(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= MyClassManager.searchMyClass(name=name,room=room,class_teacher=class_teacher,subjects=subjects,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_MyClass_Employee(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= MyClassManager.getMyClass_Employee(id=id,mv=mv)
...
def ajax_MyClass_Subject(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= MyClassManager.getMyClass_Subject(id=id,mv=mv)
...
def ajax_MyClass_Student(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= MyClassManager.getMyClass_Student(id=id,mv=mv)
...
def ajax_MyClass_Attendance(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= MyClassManager.getMyClass_Attendance(id=id,mv=mv)
...
def ajax_Exam(request,id=None):
  ...
  if request.method == 'GET':
    ...
    limit=request.GET.get('limit',None)
    mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
    name= request.GET.get('name') if request.GET.get('name','').strip() else None;subject= request.GET.get('subject') if request.GET.get('subject','').strip() else None;date= request.GET.get('date') if request.GET.get('date','').strip() else None;classRoom= request.GET.get('classRoom') if request.GET.get('classRoom','').strip() else None;time= request.GET.get('time') if request.GET.get('time','').strip() else None;teacher= request.GET.get('teacher') if request.GET.get('teacher','').strip() else None;
    # NOTE: DONT POPULATE DEFAULT HERE.. WE WANT TO SEARCH HERE ONLY....
    #data Must be Normalized to required DataType..
    try:
      name = str2List(name) if( name) else name ;subject = int(subject) if( subject) else subject ;date = date(date) if( date) else date ;classRoom = str(classRoom) if( classRoom) else classRoom ;time = str(time) if( time) else time ;teacher = str2List(teacher) if( teacher) else teacher ;
    ...
    if id is not None: 
      res= ExamManager.getExam(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= ExamManager.searchExam(name=name,subject=subject,date=date,classRoom=classRoom,time=time,teacher=teacher,id=id,page=page,limit=limit,mv=mv  )
    
  #This is the implementation for POST request.
  elif request.method == 'POST':
    name= request.POST.get('name') if request.POST.get('name','').strip() else None;subject= request.POST.get('subject') if request.POST.get('subject','').strip() else None;date= request.POST.get('date') if request.POST.get('date','').strip() else None;classRoom= request.POST.get('classRoom') if request.POST.get('classRoom','').strip() else None;time= request.POST.get('time') if request.POST.get('time','').strip() else None;teacher= request.POST.get('teacher') if request.POST.get('teacher','').strip() else None;   
    name=name if name else None ;subject=subject if subject else None ;date=date if date else None ;classRoom=classRoom if classRoom else None ;time=time if time else None ;teacher=teacher if teacher else None ;    
    #data Must be Normalized to required DataType..
    try:
      name = str2List(name) if( name) else name ;subject = int(subject) if( subject) else subject ;date = date(date) if( date) else date ;classRoom = str(classRoom) if( classRoom) else classRoom ;time = str(time) if( time) else time ;teacher = str2List(teacher) if( teacher) else teacher ;      
    except Exception,e:
    ...
    # Update request if id is not null. 
    if id is not None: 
      res=ExamManager.updateExam(id=id,name=name,subject=subject,date=date,classRoom=classRoom,time=time,teacher=teacher,)
    else:
      # This is new entry request...
      res=ExamManager.createExam(name=name,subject=subject,date=date,classRoom=classRoom,time=time,teacher=teacher,)
...
def ajax_Exam_Subject(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= ExamManager.getExam_Subject(id=id,mv=mv)
...
def ajax_Exam_Employee(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= ExamManager.getExam_Employee(id=id,mv=mv)
...
def ajax_Exam_Mark(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= ExamManager.getExam_Mark(id=id,mv=mv)
...
def ajax_Exam_Result(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= ExamManager.getExam_Result(id=id,mv=mv)
...
def ajax_Exam_asearch(request): # We support POST only .
  ...
  # This is basically a append to a list with given arguments
    ...
    id=request.POST.get('id',None)    
    try: 
      #name = parseTriple(request.POST.get('name',None));subject = parseTriple(request.POST.get('subject',None));date = parseTriple(request.POST.get('date',None));classRoom = parseTriple(request.POST.get('classRoom',None));time = parseTriple(request.POST.get('time',None));teacher = parseTriple(request.POST.get('teacher',None));
      non_field_params = ['orderBy','include','exclude']
      orderBy = request.POST.get('orderBy',None);
      if orderBy: orderBy = orderBy.split(',')
      include = request.POST.get('include',None);
...
def ajax_Student(request,id=None):
  ...
  #This is the implementation for POST request.
    ...
    # Update request if id is not null. 
    if id is not None: 
      res=StudentManager.updateStudent(id=id,name=name,email=email,phone=phone,address=address,dob=dob,doj=doj,gender=gender,parent=parent,myclass=myclass,roll=roll,section=section,)
    else:
      # This is new entry request...
      res=StudentManager.createStudent(name=name,email=email,phone=phone,address=address,dob=dob,doj=doj,gender=gender,parent=parent,myclass=myclass,roll=roll,section=section,)
...
def ajax_Student_Parent(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= StudentManager.getStudent_Parent(id=id,mv=mv)
...
def ajax_Student_MyClass(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= StudentManager.getStudent_MyClass(id=id,mv=mv)
...
def ajax_Student_Mark(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= StudentManager.getStudent_Mark(id=id,mv=mv)
...
def ajax_Student_Result(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= StudentManager.getStudent_Result(id=id,mv=mv)
...
def ajax_Student_Attendance(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= StudentManager.getStudent_Attendance(id=id,mv=mv)
...
def ajax_Student_Fees(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= StudentManager.getStudent_Fees(id=id,mv=mv)
...
def ajax_Student_Sport(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= StudentManager.getStudent_Sport(id=id,mv=mv)
...
def ajax_Mark(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= MarkManager.getMark(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= MarkManager.searchMark(student=student,subject=subject,exam=exam,written=written,viva=viva,practical=practical,total=total,comment=comment,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Mark_Student(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= MarkManager.getMark_Student(id=id,mv=mv)
...
def ajax_Mark_Subject(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= MarkManager.getMark_Subject(id=id,mv=mv)
...
def ajax_Mark_Exam(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= MarkManager.getMark_Exam(id=id,mv=mv)
...
def ajax_Result(request,id=None):
  ...
  if request.method == 'GET':
    ...
    limit=request.GET.get('limit',None)
    mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
    exam= request.GET.get('exam') if request.GET.get('exam','').strip() else None;Student= request.GET.get('Student') if request.GET.get('Student','').strip() else None;total= request.GET.get('total') if request.GET.get('total','').strip() else None;percentage= request.GET.get('percentage') if request.GET.get('percentage','').strip() else None;division= request.GET.get('division') if request.GET.get('division','').strip() else None;comment= request.GET.get('comment') if request.GET.get('comment','').strip() else None;
    # NOTE: DONT POPULATE DEFAULT HERE.. WE WANT TO SEARCH HERE ONLY....
    #data Must be Normalized to required DataType..
    try:
      exam = int(exam) if( exam) else exam ;Student = str2List(Student) if( Student) else Student ;total = int(total) if( total) else total ;percentage = int(percentage) if( percentage) else percentage ;division = str2List(division) if( division) else division ;comment = str(comment) if( comment) else comment ;
    ...
    if id is not None: 
      res= ResultManager.getResult(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= ResultManager.searchResult(exam=exam,Student=Student,total=total,percentage=percentage,division=division,comment=comment,id=id,page=page,limit=limit,mv=mv  )
    
  #This is the implementation for POST request.
  elif request.method == 'POST':
    exam= request.POST.get('exam') if request.POST.get('exam','').strip() else None;Student= request.POST.get('Student') if request.POST.get('Student','').strip() else None;total= request.POST.get('total') if request.POST.get('total','').strip() else None;percentage= request.POST.get('percentage') if request.POST.get('percentage','').strip() else None;division= request.POST.get('division') if request.POST.get('division','').strip() else None;comment= request.POST.get('comment') if request.POST.get('comment','').strip() else None;   
    exam=exam if exam else None ;Student=Student if Student else None ;total=total if total else None ;percentage=percentage if percentage else None ;division=division if division else None ;comment=comment if comment else None ;    
    #data Must be Normalized to required DataType..
    try:
      exam = int(exam) if( exam) else exam ;Student = str2List(Student) if( Student) else Student ;total = int(total) if( total) else total ;percentage = int(percentage) if( percentage) else percentage ;division = str2List(division) if( division) else division ;comment = str(comment) if( comment) else comment ;      
    except Exception,e:
    ...
    # Update request if id is not null. 
    if id is not None: 
      res=ResultManager.updateResult(id=id,exam=exam,Student=Student,total=total,percentage=percentage,division=division,comment=comment,)
    else:
      # This is new entry request...
      res=ResultManager.createResult(exam=exam,Student=Student,total=total,percentage=percentage,division=division,comment=comment,)
...
def ajax_Result_Exam(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= ResultManager.getResult_Exam(id=id,mv=mv)
...
def ajax_Result_Student(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= ResultManager.getResult_Student(id=id,mv=mv)
...
def ajax_Result_asearch(request): # We support POST only .
  ...
  # This is basically a append to a list with given arguments
    ...
    id=request.POST.get('id',None)    
    try: 
      #exam = parseTriple(request.POST.get('exam',None));Student = parseTriple(request.POST.get('Student',None));total = parseTriple(request.POST.get('total',None));percentage = parseTriple(request.POST.get('percentage',None));division = parseTriple(request.POST.get('division',None));comment = parseTriple(request.POST.get('comment',None));
      non_field_params = ['orderBy','include','exclude']
      orderBy = request.POST.get('orderBy',None);
      if orderBy: orderBy = orderBy.split(',')
      include = request.POST.get('include',None);
...
def ajax_Attendance(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= AttendanceManager.getAttendance(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= AttendanceManager.searchAttendance(student=student,myclass=myclass,total=total,percentage=percentage,comment=comment,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Attendance_Student(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= AttendanceManager.getAttendance_Student(id=id,mv=mv)
...
def ajax_Attendance_MyClass(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= AttendanceManager.getAttendance_MyClass(id=id,mv=mv)
...
def ajax_Fees(request,id=None):
  ...
  if request.method == 'GET':
    ...
    limit=request.GET.get('limit',None)
    mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
    name= request.GET.get('name') if request.GET.get('name','').strip() else None;accid= request.GET.get('accid') if request.GET.get('accid','').strip() else None;total= request.GET.get('total') if request.GET.get('total','').strip() else None;breakup= request.GET.get('breakup') if request.GET.get('breakup','').strip() else None;Student= request.GET.get('Student') if request.GET.get('Student','').strip() else None;
    # NOTE: DONT POPULATE DEFAULT HERE.. WE WANT TO SEARCH HERE ONLY....
    #data Must be Normalized to required DataType..
    try:
      name = str(name) if( name) else name ;accid = int(accid) if( accid) else accid ;total = int(total) if( total) else total ;breakup = dict(breakup) if( breakup) else breakup ;Student = str2List(Student) if( Student) else Student ;
    ...
    if id is not None: 
      res= FeesManager.getFees(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= FeesManager.searchFees(name=name,accid=accid,total=total,breakup=breakup,Student=Student,id=id,page=page,limit=limit,mv=mv  )
    
  #This is the implementation for POST request.
  elif request.method == 'POST':
    name= request.POST.get('name') if request.POST.get('name','').strip() else None;accid= request.POST.get('accid') if request.POST.get('accid','').strip() else None;total= request.POST.get('total') if request.POST.get('total','').strip() else None;breakup= request.POST.get('breakup') if request.POST.get('breakup','').strip() else None;Student= request.POST.get('Student') if request.POST.get('Student','').strip() else None;   
    name=name if name else None ;accid=accid if accid else None ;total=total if total else None ;breakup=breakup if breakup else {'house_rent':0,'food':0,'traval':0} ;Student=Student if Student else None ;    
    #data Must be Normalized to required DataType..
    try:
      name = str(name) if( name) else name ;accid = int(accid) if( accid) else accid ;total = int(total) if( total) else total ;breakup = dict(breakup) if( breakup) else breakup ;Student = str2List(Student) if( Student) else Student ;      
    except Exception,e:
    ...
    # Update request if id is not null. 
    if id is not None: 
      res=FeesManager.updateFees(id=id,name=name,accid=accid,total=total,breakup=breakup,Student=Student,)
    else:
      # This is new entry request...
      res=FeesManager.createFees(name=name,accid=accid,total=total,breakup=breakup,Student=Student,)
...
def ajax_Fees_Student(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= FeesManager.getFees_Student(id=id,mv=mv)
...
def ajax_Fees_asearch(request): # We support POST only .
  ...
  # This is basically a append to a list with given arguments
    ...
    id=request.POST.get('id',None)    
    try: 
      #name = parseTriple(request.POST.get('name',None));accid = parseTriple(request.POST.get('accid',None));total = parseTriple(request.POST.get('total',None));breakup = parseTriple(request.POST.get('breakup',None));Student = parseTriple(request.POST.get('Student',None));
      non_field_params = ['orderBy','include','exclude']
      orderBy = request.POST.get('orderBy',None);
      if orderBy: orderBy = orderBy.split(',')
      include = request.POST.get('include',None);
...
def ajax_Sport(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= SportManager.getSport(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= SportManager.searchSport(name=name,position=position,student=student,categories=categories,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Sport_Student(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= SportManager.getSport_Student(id=id,mv=mv)
...
def ajax_Account(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= AccountManager.getAccount(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= AccountManager.searchAccount(name=name,email=email,password_hash=password_hash,salt_hash=salt_hash,active=active,clue=clue,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Account_Setting(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= AccountManager.getAccount_Setting(id=id,mv=mv)
...
def ajax_Setting(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= SettingManager.getSetting(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= SettingManager.searchSetting(name=name,account=account,theme=theme,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Setting_Account(request,id=None):
  ...
  if request.method == 'GET':
      mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
      res= SettingManager.getSetting_Account(id=id,mv=mv)
...
def ajax_Fund(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= FundManager.getFund(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= FundManager.searchFund(name=name,tenant=tenant,purpose=purpose,type=type,amount=amount,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Book(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      ...
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= BookManager.searchBook(name=name,author=author,desc=desc,count=count,price=price,categories=categories,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Event(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= EventManager.getEvent(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= EventManager.searchEvent(name=name,details=details,categories=categories,date=date,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Discipline(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= DisciplineManager.getDiscipline(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= DisciplineManager.searchDiscipline(name=name,details=details,categories=categories,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Notice(request,id=None):
  ...
  if request.method == 'GET':
    ...
    if id is not None: 
      res= NoticeManager.getNotice(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= NoticeManager.searchNotice(title=title,details=details,categories=categories,id=id,page=page,limit=limit,mv=mv  )
...
def ajax_Instrument(request,id=None):
  ...
  if request.method == 'GET':
    ...
    limit=request.GET.get('limit',None)
    mv=request.GET.get('mv',None) # this is an Adding to get Mini View.. 
    name= request.GET.get('name') if request.GET.get('name','').strip() else None;details= request.GET.get('details') if request.GET.get('details','').strip() else None;categories= request.GET.get('categories') if request.GET.get('categories','').strip() else None;purchage_date= request.GET.get('purchage_date') if request.GET.get('purchage_date','').strip() else None;count= request.GET.get('count') if request.GET.get('count','').strip() else None;
    # NOTE: DONT POPULATE DEFAULT HERE.. WE WANT TO SEARCH HERE ONLY....
    #data Must be Normalized to required DataType..
    try:
      name = str(name) if( name) else name ;details = str(details) if( details) else details ;categories = str2List(categories) if( categories) else categories ;purchage_date = date(purchage_date) if( purchage_date) else purchage_date ;count = int(count) if( count) else count ;
    ...
    if id is not None: 
      res= InstrumentManager.getInstrument(id,mv=mv)
    else:
      # General Search request 
      id=request.GET.get('id',None) # We also support search based on ID.
      res= InstrumentManager.searchInstrument(name=name,details=details,categories=categories,purchage_date=purchage_date,count=count,id=id,page=page,limit=limit,mv=mv  )
    
  #This is the implementation for POST request.
  elif request.method == 'POST':
    name= request.POST.get('name') if request.POST.get('name','').strip() else None;details= request.POST.get('details') if request.POST.get('details','').strip() else None;categories= request.POST.get('categories') if request.POST.get('categories','').strip() else None;purchage_date= request.POST.get('purchage_date') if request.POST.get('purchage_date','').strip() else None;count= request.POST.get('count') if request.POST.get('count','').strip() else None;   
    name=name if name else None ;details=details if details else None ;categories=categories if categories else None ;purchage_date=purchage_date if purchage_date else None ;count=count if count else 0 ;    
    #data Must be Normalized to required DataType..
    try:
      name = str(name) if( name) else name ;details = str(details) if( details) else details ;categories = str2List(categories) if( categories) else categories ;purchage_date = date(purchage_date) if( purchage_date) else purchage_date ;count = int(count) if( count) else count ;      
    except Exception,e:
    ...
    # Update request if id is not null. 
    if id is not None: 
      res=InstrumentManager.updateInstrument(id=id,name=name,details=details,categories=categories,purchage_date=purchage_date,count=count,)
    else:
      # This is new entry request...
      res=InstrumentManager.createInstrument(name=name,details=details,categories=categories,purchage_date=purchage_date,count=count,)
...
def ajax_Instrument_asearch(request): # We support POST only .
  ...
  # This is basically a append to a list with given arguments
    ...
    id=request.POST.get('id',None)    
    try: 
      #name = parseTriple(request.POST.get('name',None));details = parseTriple(request.POST.get('details',None));categories = parseTriple(request.POST.get('categories',None));purchage_date = parseTriple(request.POST.get('purchage_date',None));count = parseTriple(request.POST.get('count',None));
      non_field_params = ['orderBy','include','exclude']
      orderBy = request.POST.get('orderBy',None);
      if orderBy: orderBy = orderBy.split(',')
      include = request.POST.get('include',None);
