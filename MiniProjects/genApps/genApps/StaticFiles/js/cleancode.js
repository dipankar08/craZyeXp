...
var GitHubProxy = function (){
    ...
    this._base_url_api =''
    this._base_url_raw =''
    this._cb_get_file_success = function(){console.log('file retrive')}
    this._cb_get_file_error = function(){console.log('file retrive failed')}
}
GitHubProxy.prototype.getFileContent=function(url){
    ...
    $.ajax({
        ...
        success: function(data){
            this._cb_get_file_success(data)
        },
        error: function(data){
            this._cb_get_file_error(data)
        }
    });
}
